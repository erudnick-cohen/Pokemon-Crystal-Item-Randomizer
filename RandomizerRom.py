...
def ReplaceItems(locations):
	replacement_table = {"POTION":"FULL_RESTORE",
						 "SUPER_POTION": "FULL_RESTORE",
						 "HYPER_POTION": "FULL_RESTORE",
						 "MAX_POTION": "FULL_RESTORE",
						 "POKE_BALL": "ULTRA_BALL",
						 "GREAT_BALL": "ULTRA_BALL",
						 "ANTIDOTE": "MIRACLEBERRY",
						 "AWAKENING": "MIRACLEBERRY",
						 "PARLYZ_Heal": "MIRACLEBERRY",
						 "ICE_HEAL": "MIRACLEBERRY",
						 "BURN_HEAL": "MIRACLEBERRY",
						 "ETHER": "MAX_ELIXER",
						 "MAX_ETHER": "MAX_ELIXER",
						 "ELIXER": "MAX_ELIXER",
						 "REVIVE": "MAX_REVIVE",
						 "REVIVAL_HERB": "MAX_REVIVE",
						 "STARDUST": "BRIGHTPOWDER",
						 "BERRY": "FULL_RESTORE",
						 "PSNCUREBERRY": "MIRACLEBERRY",
						 "PRZCUREBERRY": "MIRACLEBERRY",
						 "BURNT_BERRY": "MIRACLEBERRY",
						 "ICE_BERRY": "MIRACLEBERRY",
						 "BITTER_BERRY": "MIRACLEBERRY",
						 "MINT_BERRY": "MIRACLEBERRY",
						 ...
						 "REPEL": "MAX_REPEL",
						 "SUPER_REPEL": "MAX_REPEL",
						 "HARD_STONE": "HEAVY_BALL",
						 "MYSTIC_WATER": "LURE_BALL",
						 "MAGNET": "FAST_BALL",
						 "CHARCOAL": "LEVEL_BALL",
						 "MIRACLE_SEED": "FRIEND_BALL",
						 "PINK_BOW": "MOON_BALL",
						 "POLKADOT_BOW": "MOON_BALL",
						 "POISON_BARB": "LEVEL_BALL",
						 "TWISTEDSPOON": "LOVE_BALL",
						 "SHARP_BEAK": "FRIEND_BALL",
						 "SILVERPOWDER": "FRIEND_BALL",
						 "SPELL_TAG": "FAST_BALL",
						 "METAL_COAT": "HEAVY_BALL",
						 "DRAGON_FANG": "LURE_BALL",
						 "BLACKGLASSES": "LOVE_BALL",
						 "BLACKBELT": "HEAVY_BALL",
						 "SOFT_SAND": "LOVE_BALL",
						 "NEVERMELTICE": "LURE_BALL",
	...
	for location in locations:
		if location.isItem():
			if location.item in replacement_table:
				location.item = replacement_table[location.item]
