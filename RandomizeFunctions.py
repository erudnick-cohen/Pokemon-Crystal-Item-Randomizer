...
def IterateRequirements(location, locations, known, partial_known=[]):
    ...
    for req in location.LocationReqs:
        ...
        for data in reqData:
            ...
            # Sometimes the ordering is not the logical expectation, so also add these requirements here!
            # Otherwise, when added to known -- they are skipped and cause errors
