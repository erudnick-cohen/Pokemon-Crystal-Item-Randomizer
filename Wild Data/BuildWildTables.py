...
grassfile = open("../VanillaSpeedCrystal/pokecrystal-speedchoice/data/wild/johto_grass.asm")
...
grassfile = open("../VanillaSpeedCrystal/pokecrystal-speedchoice/data/wild/kanto_grass.asm")
grasstext = grassfile.read()
regex = re.compile(restringgrass)
results = regex.findall(grasstext)
...
grassfile = open("../VanillaSpeedCrystal/pokecrystal-speedchoice/data/wild/swarm_grass.asm")
grasstext = grassfile.read()
regex = re.compile(restringgrass)
results = regex.findall(grasstext)
...
waterfile = open("../VanillaSpeedCrystal/pokecrystal-speedchoice/data/wild/kanto_water.asm")
...
waterfile = open("../VanillaSpeedCrystal/pokecrystal-speedchoice/data/wild/johto_water.asm")
watertext = waterfile.read()
regex = re.compile(restringwater)
results = regex.findall(watertext)
for i in results:
