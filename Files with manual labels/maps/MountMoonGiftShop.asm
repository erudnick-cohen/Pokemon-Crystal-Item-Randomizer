...
.ckir_BEFORE_shop_events_MOONSHOP::
	object_event  4,  3, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MountMoonGiftShopClerkScript, -1
.ckir_AFTER_shop_events_MOONSHOP::
