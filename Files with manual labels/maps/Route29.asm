...
.DoesTuscanyAppear:
	readvar VAR_WEEKDAY
.ckir_BEFORE_timed_events_TUSCANY::
    ifequal 10, .TuscanyDisappears
.ckir_AFTER_timed_events_TUSCANY::
...
TuscanyScript:
	...
	readvar VAR_WEEKDAY
.ckir_BEFORE_timed_events_TUSCANY2::
	ifequal 10, TuscanyNotTuesdayScript
.ckir_AFTER_timed_events_TUSCANY2::
